...
CLASS_DATA = {
    UnitClass.MERCENARY: ClassStats(
        base_hp=5, base_str=5, base_magic=-3,
        base_skill=5, base_speed=5, base_luck=2,
        base_defense=2, base_res=-2,

        growth_hp=0.10, growth_str=0.15, growth_magic=0,
        growth_skill=0.10, growth_speed=0.15,
        growth_luck=0.10, growth_defense=0.15, growth_res=0.05
    ),
    UnitClass.MAGE: ClassStats(
        base_hp=0, base_str=-3, base_magic=5,
    ...
    UnitClass.FIGHTER: ClassStats(
        base_hp=10, base_str=10, base_magic=-3,
    ...
    UnitClass.KNIGHT: ClassStats(
        base_hp=10, base_str=8, base_magic=-3,
        base_skill=5, base_speed=-3, base_luck=0,
        base_defense=10, base_res=-3,
    ...
    UnitClass.SWORDMASTER: ClassStats(
        base_hp=5, base_str=3, base_magic=-3,
        base_skill=5, base_speed=10, base_luck=5,
        base_defense=0, base_res=0,
    ...
    UnitClass.BERSERKER: ClassStats(
        base_hp=15, base_str=10, base_magic=-3,
    ...
    UnitClass.THIEF: ClassStats(
        base_hp=2, base_str=0, base_magic=2,
        base_skill=3, base_speed=8, base_luck=2,
        base_defense=0, base_res=6,
    ...
    UnitClass.SOLDIER: ClassStats(
        base_hp=5, base_str=2, base_magic=-3,
        base_skill=10, base_speed=0, base_luck=5,
        base_defense=5, base_res=0,
    ...
    UnitClass.ARCHER: ClassStats(
        base_hp=4, base_str=0, base_magic=-3,

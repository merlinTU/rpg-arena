fighter_names = [
    ...
    "Dorian", "Seraphina", "Balthazar", "Elysia", "Lucian", "Talon", "Selene",
    "Vesper", "Orin", "Leona", "Drake", "Azura", "Kieran", "Morgana", "Jareth",
    "Riven", "Zara", "Cyrus", "Nyx", "Alaric", "Eira", "Thane", "Kaida", "Ronan",
    "Lunara", "Evander", "Sable", "Rowan", "Ishtar", "Dante", "Celeste", "Garrick",
    "Lyric", "Tobias", "Elowen", "Fenris", "Amara", "Veyra", "Oberon", "Kassia",
    "Soren", "Velora", "Quillon", "Arwen", "Daxton", "Selwyn", "Evangeline",
